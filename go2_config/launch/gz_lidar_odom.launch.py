...
def generate_launch_description():
    ...
    ros_bridge_config = os.path.join(config_pkg_share, "config/ros_bridge/ros_gazebo_bridge.yaml")
    ...
    declare_world_name = DeclareLaunchArgument("slope_with_pillar_2", default_value="default")
    ...
    map_odom_tf = ExecuteProcess(
        cmd=[
            'ros2', 'run', 'go2_config', 'map_odom_tf.py',
        ],
        output='screen',
        shell=False,
    )
